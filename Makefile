...
default: pokemon_lite

pokemon_lite: $(OBJS)
	$(CC) -o pokemon_lite $(OBJS) 
...
Rival.o: Rival.cpp Rival.h GameCommand.h BattleArena.h
	$(CC) -c Rival.cpp -o Rival.o

BattleArena.o: BattleArena.cpp BattleArena.h Building.h
